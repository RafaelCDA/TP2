...
TEST_CASE("0 vence por linha - caso 2", "[lino2]")
{
  int t[3][3] = {
      {1, 0, 2},
      {2, 2, 2},
...
TEST_CASE("0 vence por linha - caso 3", "[lino3]")
{
  int t[3][3] = {
      {0, 1, 0},
      {1, 0, 1},
...
TEST_CASE("0 vence por diagonal principal", "[diago]")
{
  int t[3][3] = {
      {2, 2, 1},
      {1, 2, 0},
...
TEST_CASE("0 vence por diagonal secundária", "[diago2]")
{
  int t[3][3] = {
      {1, 2, 2},
      {1, 2, 0},
